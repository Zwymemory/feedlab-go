...
func TestSwaggerDocRoute(t *testing.T) {
	...
	for _, path := range []string{"/healthz", "/api/v1/auth/register", "/api/v1/posts", "/api/v1/posts/{id}/like", "/api/v1/posts/{id}/liked", "/api/v1/users/{id}/likes", "/api/v1/posts/{id}/comments", "/api/v1/comments/{id}/replies", "/api/v1/comments/{id}"} {
